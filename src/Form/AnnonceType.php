...
class AnnonceType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('chambres', IntegerType::class, $this->getConfiguration("Année du véhicule", "L'année de votre véhicule"))
            ->add('prix', MoneyType::class, $this->getConfiguration("Prix par jour", "Indiquez le prix que vous voulez par jour de votre location"))
